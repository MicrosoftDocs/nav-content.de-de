...
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="f9ff1-103">Designdetails: Codeunit 408 Dimension Management</span><span class="sxs-lookup"><span data-stu-id="f9ff1-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="f9ff1-104">Codeunit 408 Dimension Management ist eine Funktionsbibliothek, die häufige Aufgaben im Zusammenhang mit Dimensionen behandelt, wie etwa das Kopieren von einer Tabelle zu einer anderen oder von einem Beleg zu einem anderen.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="f9ff1-105">Dieses Thema listet die Funktionen auf, die in Microsoft Dynamics NAV 2013 R2 geändert werden und gibt an, was mit den Funktionen durchgeführt werden muss.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="f9ff1-106">Viele Funktionalitäten werden gelöscht, da ein Kopieren zwischen Dimensionstabellen nicht erforderlich gibt.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="f9ff1-107">Geänderte Funktionen</span><span class="sxs-lookup"><span data-stu-id="f9ff1-107">Modified Functions</span></span>  

|<span data-ttu-id="f9ff1-108">Funktionsname</span><span class="sxs-lookup"><span data-stu-id="f9ff1-108">Function Name</span></span>|<span data-ttu-id="f9ff1-109">Modifizierungsbeschreibung</span><span class="sxs-lookup"><span data-stu-id="f9ff1-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="f9ff1-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="f9ff1-111">Neue Funktion, die die anderen Scheckfunktionen ersetzt und nimmt eine Dimensionssatz-ID als ein Argument anstelle einer Dimensionstabelle.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="f9ff1-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="f9ff1-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="f9ff1-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="f9ff1-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="f9ff1-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="f9ff1-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="f9ff1-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="f9ff1-117">CheckDimValueComb</span></span>|<span data-ttu-id="f9ff1-118">LÖSCHEN.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-118">Delete.</span></span> <span data-ttu-id="f9ff1-119">Die gesamte Nutzung sollte zu CheckDimSetIDComb geändert werden.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="f9ff1-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-120">GetDefaultDim</span></span>|<span data-ttu-id="f9ff1-121">"Ändern", um eine ganzzahlige Dimensionssatz-ID anstelle eines Satzes von Datensätzen zurückzusenden.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="f9ff1-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="f9ff1-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="f9ff1-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="f9ff1-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="f9ff1-126">Ändern, um mit DimSetID zu arbeiten - > ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="f9ff1-127">Gelöschte Funktionen</span><span class="sxs-lookup"><span data-stu-id="f9ff1-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="f9ff1-129">Während des Upgrades des Anwendungscodes von Microsoft Dynamics NAV 2009 oder früheren Versionen zu Microsoft Dynamics NAV 2016 sind die folgenden Funktionen nicht in Microsoft Dynamics NAV 2016 verfügbar.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="f9ff1-130">Wenn Sie Anpassungen haben, die einen oder mehrere der Funktionalitäten verwenden, müssen Sie diesen Code entsprechend aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="f9ff1-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="f9ff1-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="f9ff1-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="f9ff1-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="f9ff1-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="f9ff1-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="f9ff1-205">CopyJnlLineDimToBuffer</span></span>  
