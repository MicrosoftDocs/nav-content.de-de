...
## <a name="to-set-up-an-opportunity-sales-cycle-code"></a>Einrichten eines Verkaufsprozesscodes
1. Wählen Sie in der rechten oberen Ecke das Symbol **Nach Seite oder Bericht suchen** aus und geben Sie **Verkaufsprozesse** ein. Wählen Sie dann den zugehörigen Link aus. Das **Verkaufsprozesse**-Fenster wird geöffnet und führt alle vorhandenen Verkaufsprozesse auf.
...
## <a name="to-assign-stage-cycle-to-an-opportunity"></a>Eine Verkaufsprozessstufe zu einer Verkaufschance zuordnen
